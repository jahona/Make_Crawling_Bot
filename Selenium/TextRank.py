...
class SentenceTokenizer(object):
    def __init__(self):
        ...
        '안녕', '우려', '차근차근', '일일이', '듯이', '대체', '무엇', '도대체', '저건', '어가', '그동안', '그것', '닥치고', '지라', '해도', '치면', '고작', '근처',
        '차지', '덕분', '꿰어', '차고', '덕분', '더욱', '아주', '워낙', '조차', '이외', '가끔', '아주', '해도', '게다가', '차지', '적도', '위쪽', '얼마나',
        '해도', '묵적', '굳이', '편집', '본문', '점차', '더욱더', '깨알', '육박', '가가', '서도', '남아', '해지', '보라', '수록', '부어', '구', '돕기',
        '또렷', '전혀', '겨우', '그다지', '널린', '저리', '지고', '일어나고', '무르익어', '더러', '어서', '수록', '따위', '일어나지', '아예', '본격',
        '이듬해', '역시', '이따', '것일']
